...
export class Backend implements backendInterface {
    ...
    async checkIn(arg0: SessionId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createSession(arg0: string, arg1: Time, arg2: Time): Promise<Session> {
        if (this.processError) {
            try {
    ...
    async getAttendanceForSession(arg0: SessionId): Promise<Array<AttendanceRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAttendanceForSession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserAttendance(arg0: Principal): Promise<Array<AttendanceRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserAttendance(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
